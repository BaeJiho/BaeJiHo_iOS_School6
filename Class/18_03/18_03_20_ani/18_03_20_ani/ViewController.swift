...
class ViewController: UIViewController {
    ...
    @objc func firstMenuDidTap(_ button: UIButton) {
        ...
        UIView.animate(withDuration: Time.middle, delay: 0, usingSpringWithDamping: 0.5, initialSpringVelocity: 0, options: [], animations: {
    ...
    @objc private func secondMenuDidTap(_ button: UIButton) {
        ...
        UIView.animateKeyframes(withDuration: Time.middle, delay: 0, options: [.beginFromCurrentState], animations: {
